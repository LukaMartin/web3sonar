...
import { SimulatedTransactionResult } from "../../types/gas-dashboard/simultedTransactionResult";

type TransactionSimulationResultProps = {
...
export default function TransactionSimulationResult({
  ...
  return (
    <div>
      ...
      <div className="bg-white/[3%] rounded-md p-6 shadow-[0_7px_5px_rgba(2,2,2,1)] min-w-96 max-w-[40rem]">
        ...
        !simulationResult.error ? (
          <p className="pb-2 text-green-yellow text-lg">

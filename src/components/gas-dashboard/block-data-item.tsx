...
export default function BlockDataItem({ name, value }: BlockDataItemProps) {
  return (
    <div className="text-left bg-white/[3%] border-[1px] border-white/20 shadow-[0_5px_5px_rgba(2,2,2,1)] rounded-md w-[48%] lg:w-[23.5%] my-2 sm:my-0 py-2 px-[0.4rem] md:px-3">

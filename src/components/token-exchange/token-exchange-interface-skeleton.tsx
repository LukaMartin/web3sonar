export default function TokenExchangeInterfaceSkeleton() {
  return (
    <section className="pb-1">
      <div className="w-[375px] h-[575px] flex flex-col mx-auto mb-12 bg-white/10 border-[1px] border-white/20 rounded-md animate-pulseStrong">
        ...
        <div className="px-7 mt-8">
          <div className="bg-white/20 h-6 w-[4.5rem] rounded-md" />
        </div>
        ...
        <div className="px-7 mt-10">
          <div className="w-full bg-white/20 h-12 rounded-md" />
        </div>

        <div className="self-end mt-4 mb-4 mr-6">
          <div className="w-[6.25rem] bg-white/20 h-5 rounded-md" />
        </div>
      </div>
    </section>
  );
